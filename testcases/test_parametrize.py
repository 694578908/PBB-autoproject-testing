...
class TestClient:
    ...
    @pytest.mark.parametrize('case', YamlUtil().read_testcase_data_yaml('PBB_app_login.yml', 'PBB_app_login'))
    ...
    @allure.feature('C端')
    @pytest.mark.parametrize('case', YamlUtil().read_testcase_data_yaml('C_module.yml', 'C_module'))
    def test_case_C_module(self, case):
        case_request(case)

    @allure.feature('B端')
    @pytest.mark.parametrize('case', YamlUtil().read_testcase_data_yaml('B_module.yml', 'B_module'))
...
class TestBackground:
    ...
    @pytest.mark.parametrize('case', YamlUtil().read_testcase_data_yaml('PBB_backstage_login.yml', 'PBB_backstage_login'))
